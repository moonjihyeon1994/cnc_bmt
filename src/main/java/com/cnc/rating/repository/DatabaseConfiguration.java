...
@EnableJpaRepositories(
        basePackages = "com.cnc.rating",
        entityManagerFactoryRef = "multiEntityManager",
        transactionManagerRef = "multiTransactionManager"
)
public class DatabaseConfiguration {

    private final String PACKAGE_SCAN = "com.cnc.rating";
...
//    }
    ...
    public DataSource multiRoutingDataSource() {
        ...
        targetDataSources.put(DatabaseType.A, mainDataSource());
        targetDataSources.put(DatabaseType.B, clientADataSource());
//        targetDataSources.put(DatabaseType.C, clientBDataSource());
